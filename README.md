...
## Trick to run Ansible Playbook through Jenkins job in a fully customized way enabling the user to upload the csv file used for parameterization
1.  Create 4 directories viz. Playbook, INI, hosts, scripts
2.  Playbook directory will contain the Ansible playbook, INI will contain the .ini files generated by the Python converter of csv -> ini, hosts will contain the uploaded csv file containing the parameters of your Jenkins job, scripts will contain the Python code to generate the ini from csv
3.  Refer to the generateInventoryfromcsv.py. You may modify your csv and this file according to your requirement. For eg. if you add columns, modify the python script to read those columns too.
4.  For further details, contact me on nabanishs@gmail.com or +91-9007084606
